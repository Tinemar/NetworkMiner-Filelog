...
namespace NetworkMiner {
    public static class Program {
        ...
        public static void SetupLogger(string applicationName) {
            ...
            PacketParser.Utils.Logger.Log("Environment.Version = " + Environment.Version, System.Diagnostics.EventLogEntryType.Information);//4.0.30319.42000 =  .NET Framework 4.6, its point releases, and the .NET Framework 4.7
