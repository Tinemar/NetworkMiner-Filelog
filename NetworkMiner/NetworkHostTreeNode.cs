...
namespace NetworkMiner {
    ...
    public class NetworkHostTreeNode : TreeNode, ToolInterfaces.IBeforeExpand{
        ...
        internal NetworkHostTreeNode(PacketParser.NetworkHost networkHost, Func<System.Net.IPAddress, string> ipLocator, ToolInterfaces.IHostDetailsGenerator hostDetailsGenerator) {
